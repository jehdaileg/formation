...
<AppLayoutVue>
              ...
              <template #header>
                 <div class="flex space-x-2 ">
                      <Link :href="route('dashboard')"><span class="px-2 py-2 p-4" :style="'padding:20px;'">&larr;</span></Link>
                  <h5 class="text-black font-bold">Nouvelle Formation</h5>
                        ...
                        <div class="w-full mt-3 max-w-lg mx-20">
                                <form @submit.prevent="addFormation" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                    <div class="mb-4">
                                    <label class="block text-gray-700 text-sm font-bold mb-2" for="title">
                                        Title
                                    </label>
                                    <input v-model="form.title" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username">
                                    </div>
                                            <div class="mb-4">
                                            <label for="description" class="form-label inline-block mb-2 text-gray-700"
                                            >Description</label
                                            >
                                            <textarea v-model="form.description" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid rounded transition ease-in-out m-0 focus:text-gray-700 focus:outline-none focus:border-blue-600 focus:bg-white"
                                    ...
                                    <div class="episodes mt-2">
                                        <h5 class="font-bold">Ajouter des episodes pour la formation</h5>

                                        <div v-for="(episode, index) in this.form.episodes" :key="index" class="mt-2">
                                              ...
                                              <div class="mb-4">
                                               ...
                                               <div class="mb-4">
                                                ...
                                                <label :for="index" class="block text-gray-700 text-sm font-bold mb-2"
                                    ...
                                    <div class="flex justify-start mt-2">
                                        <button v-if="this.form.episodes.length < 15" @click.prevent="addFormEpisode" class="rounded-lg px-2 py-2 bg-green-500 text-white text-center">+</button>
                                        <button v-if="this.form.episodes.length > 1" @click.prevent="removeFormEpisode" class="rounded-lg px-2 py-2 bg-red-500 text-white text-center ml-4">--</button>
    ...
    methods: {
        addFormation()
        {
           this.$inertia.post('/courses', this.form, {
               preserveState: true,
               replace: true,
               onStart: () => { console.log('On starting the request') },
