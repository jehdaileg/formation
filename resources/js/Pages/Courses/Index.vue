    ...
    <div class="py-4">
        ...
        <div class="mx-8 rounded shadow-lg px-2  py-4" v-for="course in this.ListCourses" :key="course.id">
            ...
            <div class="flex justify-between items-center">
                 ...
                 <Link :href="'/course/edit/' + course.id" v-if="course.update" class="rounded text-white px-2 py-1 text-xl bg-gray-600 hover:bg-black inline-block mt-3">Editer mon cours</Link>

                 <span class="text-sm font-bold text-indigo-400">{{ course.created_at }}</span>

                 <span v-if="course.update">Hey</span>
